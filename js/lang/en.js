I18N.registerLocale('en', {
  ...
  data: {
    ...
    traits: {
      ...
      fortress_aura: { name: 'Fortress Aura', desc: 'Defender gets +6 defense while the keeper is active.' },
      ...
      cannon_blast: { name: 'Cannon Blast', desc: 'Every shot has a 10% chance to become automatic goal, but miss chance rises by 5%.' },
    ...
    oppTells: {
      ...
      cerebral: 'Tactically polished — possession game is dangerous',
      ...
      trait_ironwall: 'Very defensive early — rounds 1-2 hard to break down',
      trait_sniper: 'Precision shooter — every shot is a threat'
    },
    tactics: {
      kickoff: {
